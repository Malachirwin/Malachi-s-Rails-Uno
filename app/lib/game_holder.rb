class GameHolder
  ...
  def to_json(options={})
    {game: game, round: round, player_said_uno: player_said_uno, player_needs_to_say_uno: player_needs_to_say_uno, must_say_uno: must_say_uno, what_happened: what_happened, result: result, message: message, wild_card_holder: wild_card_holder, player_name: player_name}.to_json
  end
end
